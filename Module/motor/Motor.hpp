...
public:
  ...
  void onRx(const uint8_t data[8], uint8_t len) override {
    ...
    raw_torque_ = uint_to_float(torque_raw_, -I_MAX, I_MAX, 12);
...
private:
  ...
  static constexpr float MIT_V_MIN = -500.0f;
  static constexpr float MIT_V_MAX = 500.0f;
  static constexpr float Kp_MIN = 0.0f;
  static constexpr float Kp_MAX = 500.0f;
  static constexpr float Kd_MIN = 0.0f;
  static constexpr float Kd_MAX = 5.0f;
  static constexpr float I_MIN = 0.0f;
  static constexpr float I_MAX = 18.0f;
